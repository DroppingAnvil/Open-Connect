...
import dev.droppinganvil.v2.ProcessX.envconfs.EnvConf;
import dev.droppinganvil.v2.ProcessX.panel.Process;
import dev.droppinganvil.v2.ProcessX.panel.*;
import dev.droppinganvil.v2.secure.userflow.EditUserRequest;

public class Adapters {
    public static Moshi moshi;
    public static JsonAdapter<LoginForm> loginFormjson;
    public static JsonAdapter<IPXAccount> clientjson;
    ...
    public static void setupAdapters(Moshi moshi) {
        ...
        clientjson = moshi.adapter(IPXAccount.class).lenient();
